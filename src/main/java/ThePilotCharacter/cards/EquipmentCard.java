...
import ThePilotCharacter.cards.equipment.*;
import ThePilotCharacter.character.PilotCharacter;
import ThePilotCharacter.patches.OnUseCardPowersAndRelicsPatch;
import ThePilotCharacter.relics.OilCan;
import ThePilotCharacter.relics.reworks.StrangeFork;
import ThePilotCharacter.ui.DurabilityTutorial;
import ThePilotCharacter.util.CardStats;
import ThePilotCharacter.util.EquipmentVisualModifier;
import ThePilotCharacter.vfx.DamageEquipmentEffect;
import ThePilotCharacter.vfx.EquipmentShowCardBrieflyEffect;
