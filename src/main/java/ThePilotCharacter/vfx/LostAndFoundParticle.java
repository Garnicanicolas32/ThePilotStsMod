...
public class LostAndFoundParticle extends AbstractGameEffect {
    ...
    public LostAndFoundParticle(float x, float y) {
        ...
        this.speedStart = MathUtils.random(200.0F, 700.0F) * Settings.scale;
        this.speedTarget = 1000.0F * Settings.scale;
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(this.img, this.x, this.y, (float) this.img.packedWidth / 2.0F, (float) this.img.packedHeight / 2.0F, (float) this.img.packedWidth, (float) this.img.packedHeight, this.scale, this.scale, this.rotation + this.flipper + MathUtils.random(-5.0F, 5.0F));
