...
public class VisorParticleEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
    ...
    public VisorParticleEffect(float xpos, float ypos) {
        ...
        this.color = new Color(MathUtils.random(0.2F, 0.4F), MathUtils.random(0.4F, 0.6F), MathUtils.random(0.8F, 1.0F), 0.0F);
        this.x = xpos + MathUtils.random(-AbstractDungeon.player.hb.width / 2.0F - 50.0F * Settings.scale, AbstractDungeon.player.hb.width / 2.0F + 50.0F * Settings.scale);
        this.y = ypos + MathUtils.random(-AbstractDungeon.player.hb.height / 2.0F + 10.0F * Settings.scale, AbstractDungeon.player.hb.height / 2.0F - 20.0F * Settings.scale);
