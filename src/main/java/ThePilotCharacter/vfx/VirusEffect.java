...
public class VirusEffect extends AbstractGameEffect {
    private float x;
    private float y;
    ...
    public VirusEffect() {
        ...
        this.color = new Color(MathUtils.random(0.2F, 0.8F), MathUtils.random(0.5F, 1.0F), MathUtils.random(0.2F, 0.8F), 0.0F);
