...
public class FallingGoldEffect extends AbstractGameEffect {
    ...
    public FallingGoldEffect(int frostCount, boolean flipped) {
        ...
        Color tempC = Color.GOLD.cpy();
        tempC.a =  MathUtils.random(0.9F, 1.0F);
        this.color = tempC;
    ...
    public void update() {
        ...
        if (!(this.waitTimer > 0.0F)) {
            ...
            if (this.y < this.floorY) {
                ...
                CardCrawlGame.sound.playA("GOLD_GAIN_4", pitch);
                this.isDone = true;
            }
