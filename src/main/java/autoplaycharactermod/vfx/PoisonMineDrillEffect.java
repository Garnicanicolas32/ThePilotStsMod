...
public class PoisonMineDrillEffect extends AbstractGameEffect {
    private float x;
    private float y;
    private float vY;
    private float aV;
    ...
    public PoisonMineDrillEffect(float x, float y, boolean grayscale) {
        this.color = new Color(0.0F, 0.0F, 0.0F, 1.0F);
        if (grayscale) {
            this.color.r = MathUtils.random(0.3F, 0.8F);
