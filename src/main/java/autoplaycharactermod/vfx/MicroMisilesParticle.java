...
public class MicroMisilesParticle extends AbstractGameEffect {
    ...
    public MicroMisilesParticle(float sX, float sY, float tX, float tY, boolean facingLeft, Color color, boolean sound, float scale) {
        ...
        this.color = color;
        this.duration = 0.7F;
        this.scale = 1F * Settings.scale * scale;
