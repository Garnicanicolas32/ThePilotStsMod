...
public class AuraButtonPatches {
    ...
    public static class DrawButton {
        public static final SpireField<autoplaycharactermod.ui.DrawButton> button = new SpireField<>(autoplaycharactermod.ui.DrawButton::new);
    }

    @SpirePatch2(clz = OverlayMenu.class, method = SpirePatch.CLASS)
    public static class ScryButton {
        public static final SpireField<autoplaycharactermod.ui.ScryButton> button = new SpireField<>(autoplaycharactermod.ui.ScryButton::new);
    }
